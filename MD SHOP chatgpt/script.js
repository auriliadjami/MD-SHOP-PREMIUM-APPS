...
const CATALOG = [
  ...
  },
  {
    ...
    category:"Design",
    packages:[
      { group:"CANVA", name:"Canva 1 Bulan", desc:"Via Invite Email • 1 Bulan", price:"IDR 3.000" },
      { group:"CANVA", name:"Canva 3 Bulan", desc:"Renew tiap bulan • IDR 3.000 / bulan", price:"IDR 3.000 / bulan" },
      { group:"CANVA", name:"Canva 1 Tahun", desc:"Renew tiap 1 bulan • IDR 6.000 / bulan", price:"IDR 6.000 / bulan" },
  ...
  ...[
    "ALIGHTMOTION","APPMUS","BSTATION","CAMSCANNER","CAPCUT","CHATGPT","DISNEY","DRAMABOX",
    "GRAMMARLY","GTC","HBO","IQIYI","JASEB","LOKLOK","MELOLO",
    "MOVIEBOX","MS365","NETFLIX","PRIME VIDEO","REELSHORT","REMINI","SEWA BOT","SHORTMAX",
    "TELEPREM","TELESTARS","VIDIO","VISION","VIU","WETV","WIBUKU","WINK","YOUKU","YOUTUBE"
  ].map(name => ({
    key: name,
    title: name,
